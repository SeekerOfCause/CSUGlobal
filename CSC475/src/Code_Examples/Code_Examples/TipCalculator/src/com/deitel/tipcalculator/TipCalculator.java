...
public class TipCalculator extends Activity 
{
   ...
   public void onCreate(Bundle savedInstanceState) 
   {
      ...
      // accepts user input for bill total
   ...
   private final OnSeekBarChangeListener customSeekBarListener =
   ...
   private final TextWatcher billEditTextWatcher = new TextWatcher()
   {
